...
for num_sample=1:N_sample    
    ...
    y=fsk16(N_code,fc,fs,fd,freqsep,Ac);
    yr=awgn(y,snr,'measured','db'); 
    yr=mapminmax(yr);
...
disp(strcat('saving',32, fdata,'_20.mat...'))
save(strcat('../CNN_samples/',fdata,'_20'),'train_x','train_y','test_x','test_y','-v7.3')
