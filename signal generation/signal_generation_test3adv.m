...
if snr <0
    fdata = strcat('test_adv','-',num2str(abs(snr)));
else
    fdata = strcat('test_adv', num2str(snr));
end

test_x_adv=[mode1(1:N_train,2:end);mode2(1:N_train,2:end);mode3(1:N_train,2:end);mode4(1:N_train,2:end);mode5(1:N_train,2:end);...
...
save(strcat('../data/adv/',fdata),'test_x_adv', 'test_y', '-v7.3')

clear test_x_adv test_y
end
