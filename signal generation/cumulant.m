...
for i=1:N
    ...
    d1 = abs(C40)/abs(C42);
    d2 = abs(C41)/abs(C42);
    d3 = abs(C42)/(abs(C21)^2);
    d4 = abs(C60)/(abs(C21)^3);
    d5 = abs(C63)/(abs(C21)^3);
    d6 = (abs(C60)^2)/(abs(C42)^3);
    d7 = (abs(C63)^2)/(abs(C42)^3);
    d8 = abs(C80)/(abs(C40)^2);
    %co(i,:)=[C20,C21,C40^(1/2),C41^(1/2),C42^(1/2),C60^(1/3),C61^(1/3),C62^(1/3),C63^(1/3),C80^(1/4)];
    co(i,:)=[d1, d2, d3, d4, d5, d6, d7, d8];
