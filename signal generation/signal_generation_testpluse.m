...
mode_pluse1= zeros(N_sample,N_code*fs/fd+1);
mode_pluse2= zeros(N_sample,N_code*fs/fd+1);
mode_pluse3= zeros(N_sample,N_code*fs/fd+1);
mode_pluse4= zeros(N_sample,N_code*fs/fd+1);
mode_pluse5= zeros(N_sample,N_code*fs/fd+1);
mode_pluse6= zeros(N_sample,N_code*fs/fd+1);
mode_pluse7= zeros(N_sample,N_code*fs/fd+1);
mode_pluse8= zeros(N_sample,N_code*fs/fd+1);
mode_pluse9= zeros(N_sample,N_code*fs/fd+1);
mode_pluse10=zeros(N_sample,N_code*fs/fd+1);
mode_pluse11=zeros(N_sample,N_code*fs/fd+1);
mode_pluse12=zeros(N_sample,N_code*fs/fd+1);
mode_pluse13=zeros(N_sample,N_code*fs/fd+1);
mode_pluse14=zeros(N_sample,N_code*fs/fd+1);
mode_pluse15=zeros(N_sample,N_code*fs/fd+1);
mode_pluse16=zeros(N_sample,N_code*fs/fd+1);
mode_pluse17=zeros(N_sample,N_code*fs/fd+1);
mode_pluse18=zeros(N_sample,N_code*fs/fd+1);
mode_pluse19=zeros(N_sample,N_code*fs/fd+1);
mode_pluse20=zeros(N_sample,N_code*fs/fd+1);
mode_pluse21=zeros(N_sample,N_code*fs/fd+1);
mode_pluse22=zeros(N_sample,N_code*fs/fd+1);
mode_pluse23=zeros(N_sample,N_code*fs/fd+1);
mode_pluse24=zeros(N_sample,N_code*fs/fd+1);
mode_pluse25=zeros(N_sample,N_code*fs/fd+1);
mode_pluse26=zeros(N_sample,N_code*fs/fd+1);
mode_pluse27=zeros(N_sample,N_code*fs/fd+1);
mode_pluse28=zeros(N_sample,N_code*fs/fd+1);
mode_pluse29=zeros(N_sample,N_code*fs/fd+1);
mode_pluse30=zeros(N_sample,N_code*fs/fd+1);
mode_pluse31=zeros(N_sample,N_code*fs/fd+1);
...
for num_sample=1:N_sample    
    ...
    y=y/sqrt(sum(y.^2));   
    N = N_code*fs/fd;
    pulse = jam_pulse(1 , fs,  fc_pluse, N);
 ...
 %   y = mapminmax(y, 0, 1);
  ...
  %  y = mapminmax(y, 0, 1);
   ...
   % y = mapminmax(y, 0, 1);
    ...
    mode_pluse31(num_sample,:)=[31,yr];
end

if snr <0
    fdata = strcat('test_pluse','_',num2str(abs(snr)));
else
    fdata = strcat('test_pluse', num2str(snr));
end
...
test_x_pulse=[mode_pluse1(1:N_train,2:end);mode_pluse2(1:N_train,2:end);mode_pluse3(1:N_train,2:end);mode_pluse4(1:N_train,2:end);mode_pluse5(1:N_train,2:end);...
    mode_pluse6(1:N_train,2:end);mode_pluse7(1:N_train,2:end);mode_pluse8(1:N_train,2:end);mode_pluse9(1:N_train,2:end);mode_pluse10(1:N_train,2:end);...
    mode_pluse11(1:N_train,2:end);mode_pluse12(1:N_train,2:end);mode_pluse13(1:N_train,2:end);mode_pluse14(1:N_train,2:end);mode_pluse15(1:N_train,2:end);...
    mode_pluse16(1:N_train,2:end);mode_pluse17(1:N_train,2:end);mode_pluse18(1:N_train,2:end);mode_pluse19(1:N_train,2:end);mode_pluse20(1:N_train,2:end);...
    mode_pluse21(1:N_train,2:end);mode_pluse22(1:N_train,2:end);mode_pluse23(1:N_train,2:end);mode_pluse24(1:N_train,2:end);mode_pluse25(1:N_train,2:end);...
    mode_pluse26(1:N_train,2:end);mode_pluse27(1:N_train,2:end);mode_pluse28(1:N_train,2:end);mode_pluse29(1:N_train,2:end);mode_pluse30(1:N_train,2:end);mode_pluse31(1:N_train,2:end)];
...
test_y=[mode_pluse1(1:N_train,1);mode_pluse2(1:N_train,1);mode_pluse3(1:N_train,1);mode_pluse4(1:N_train,1);mode_pluse5(1:N_train,1);...
    mode_pluse6(1:N_train,1);mode_pluse7(1:N_train,1);mode_pluse8(1:N_train,1);mode_pluse9(1:N_train,1);mode_pluse10(1:N_train,1);...
    mode_pluse11(1:N_train,1);mode_pluse12(1:N_train,1);mode_pluse13(1:N_train,1);mode_pluse14(1:N_train,1);mode_pluse15(1:N_train,1);...
    mode_pluse16(1:N_train,1);mode_pluse17(1:N_train,1);mode_pluse18(1:N_train,1);mode_pluse19(1:N_train,1);mode_pluse20(1:N_train,1);...
    mode_pluse21(1:N_train,1);mode_pluse22(1:N_train,1);mode_pluse23(1:N_train,1);mode_pluse24(1:N_train,1);mode_pluse25(1:N_train,1);...
    mode_pluse26(1:N_train,1);mode_pluse27(1:N_train,1);mode_pluse28(1:N_train,1);mode_pluse29(1:N_train,1);mode_pluse30(1:N_train,1);mode_pluse31(1:N_train,1)];

%test_y_audio和test_y是同一个
% test_y_audio=[mode_pluse1(1:N_train,1);mode_pluse2(1:N_train,1);mode_pluse3(1:N_train,1);mode_pluse4(1:N_train,1);mode_pluse5(1:N_train,1);...
%     mode_pluse6(1:N_train,1);mode_pluse7(1:N_train,1);mode_pluse8(1:N_train,1);mode_pluse9(1:N_train,1);mode_pluse10(1:N_train,1);...
%     mode_pluse11(1:N_train,1);mode_pluse12(1:N_train,1);mode_pluse13(1:N_train,1);mode_pluse14(1:N_train,1);mode_pluse15(1:N_train,1);...
%     mode_pluse16(1:N_train,1);mode_pluse17(1:N_train,1);mode_pluse18(1:N_train,1);mode_pluse19(1:N_train,1);mode_pluse20(1:N_train,1);...
%     mode_pluse21(1:N_train,1);mode_pluse22(1:N_train,1);mode_pluse23(1:N_train,1);mode_pluse24(1:N_train,1);mode_pluse25(1:N_train,1);...
...
disp(strcat('saving',32, fdata,'_pluse.mat...'))
save(strcat('../data/',fdata),'test_x_pulse', 'test_y','-v7.3')

clear  test_x_pulse test_y
end
